...
RSpec.describe Beer do
  it 'has proper validations set' do
    ...
    should validate_numericality_of(:international_bitterness_unit)
      .only_integer
      .is_greater_than_or_equal_to(0)
    should validate_numericality_of(:alcohol_by_volume)
      .is_greater_than_or_equal_to(0)
    should validate_numericality_of(:original_gravity)
      .is_greater_than_or_equal_to(0)
